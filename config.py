...
OWNER_USERNAME = getenv("OWNER_USERNAME","@Vip_saiya_Ji")
BOT_USERNAME = getenv("BOT_USERNAME" , "zarasaiyabot")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/sahebrajdhari03-dotcom/Rao-Sahab",)
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/zone_chatt")
